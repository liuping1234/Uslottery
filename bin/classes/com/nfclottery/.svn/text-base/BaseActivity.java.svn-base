...
public class BaseActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState){	
		  ...
		  MainNfcActivity.activityList.add(this);
	}
...
//	}
    ...
    public  void exitClient(Context context){
       // Log.d(TAG, "----- exitClient -----");
        // 关闭所有Activity
        for (int i = 0; i < MainNfcActivity.activityList.size(); i++){
            if (null != MainNfcActivity.activityList.get(i)){
            	MainNfcActivity.activityList.get(i).finish();
            }
        }
