...
import com.uslotter.mode.NewProspect;
...
public class UslotteryRecord_jzkcActivity extends Activity {
	...
	private void initView() {
		...
		back = (Button) findViewById(R.id.bt_new_back);
		save = (Button) findViewById(R.id.bt_new_save);
		sp_site = (Spinner) findViewById(R.id.sp_new_site);
		et_number = (EditText) findViewById(R.id.et_new_number);
		sp_type = (Spinner) findViewById(R.id.sp_new_type);
		sp_verify1 = (Spinner) findViewById(R.id.sp_new_verify_1);
		sp_verify2 = (Spinner) findViewById(R.id.sp_new_verify_2);
		et_explain1 = (EditText) findViewById(R.id.et_new_explain1);
		et_explain2 = (EditText) findViewById(R.id.et_new_explain2);
		et_noto = (EditText) findViewById(R.id.et_new_noto);
		iv_annx = (ImageView) findViewById(R.id.iv_new_annx);
		ll_pic = (LinearLayout) findViewById(R.id.ll_new_pic);
		et_branch = (EditText) findViewById(R.id.et_new_branch);
	...
	/** 将数据保存在实体类NewProspect中 */
	private void deposit() {
		prospect = new NewProspect();
		prospects = new ArrayList<NewProspect>();
		...
		app.setProspects(prospects);
	}

	private void showView() {
		if (app.getProspects() != null) {
			prospect = app.getProspects().get(0);
	...
	private OnClickListener saveListener = new OnClickListener() {
		...
		public void onClick(View v) {
			deposit();
			Intent intent = new Intent(UslotteryRecord_jzkcActivity.this,
					UslotteryRecord.class);
			intent.putExtra("NewProspect", app);
			intent.putExtra("flag", 11 + "");
			startActivity(intent);
			finish();
			UslotteryRecord_jzkcActivity.this.startActivity(intent);
			UslotteryRecord_jzkcActivity.this.finish();
		}
	};
	...
	OnClickListener picListener = new OnClickListener() {
		@Override
		public void onClick(View v) {
			new AlertDialog.Builder(UslotteryRecord_jzkcActivity.this)
					.setTitle("温馨提示!")
					.setMessage("选择拍照还是图库")
					.setPositiveButton("拍照",
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									UslotteryRecord_jzkcActivity.this
			...
			if (requestCode == 2) {
				...
				for (int i = 0; i < picPath.length; i++) {
					...
					String str = ImageCompress.compressImage3(bitmap,
							UslotteryRecord_jzkcActivity.this, imagepath);
