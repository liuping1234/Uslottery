...
import com.uslotter.mode.TestProspect;
...
public class UslotteryRecord_yskcActivity extends Activity {
	...
	private TestProspect prospect;

	private ArrayList<TestProspect> prospects;
	...
	private void initView() {
		...
		back = (Button) findViewById(R.id.bt_test_back);
		save = (Button) findViewById(R.id.bt_test_save);
		sp_site = (Spinner) findViewById(R.id.sp_test_site);
		et_number = (EditText) findViewById(R.id.et_test_number);
		sp_type = (Spinner) findViewById(R.id.sp_test_type);
		sp_verify1 = (Spinner) findViewById(R.id.sp_test_verify_1);
		sp_verify2 = (Spinner) findViewById(R.id.sp_test_verify_2);
		et_explain1 = (EditText) findViewById(R.id.et_test_explain1);
		et_explain2 = (EditText) findViewById(R.id.et_test_explain2);
		et_noto = (EditText) findViewById(R.id.et_test_noto);
		iv_annx = (ImageView) findViewById(R.id.iv_test_annx);
		ll_pic = (LinearLayout) findViewById(R.id.ll_test_pic);
		et_branch = (EditText) findViewById(R.id.et_test_branch);
	...
	/** 将数据保存在实体类TestProspect中 */
	private void deposit() {
		prospect = new TestProspect();
		prospects = new ArrayList<TestProspect>();
		...
		app.setTestProspects(prospects);
	}

	private void showView() {
		if (app.getTestProspects() != null) {
			prospect = app.getTestProspects().get(0);
	...
	private OnClickListener saveListener = new OnClickListener() {
		...
		public void onClick(View v) {
			deposit();
			Intent intent = new Intent(UslotteryRecord_yskcActivity.this,
					UslotteryRecord.class);
			intent.putExtra("TestProspect", app);
			intent.putExtra("flag", 13 + "");
			startActivity(intent);
			finish();
			UslotteryRecord_yskcActivity.this.startActivity(intent);
			UslotteryRecord_yskcActivity.this.finish();
		}
	};
	...
	OnClickListener picListener = new OnClickListener() {
		@Override
		public void onClick(View v) {
			new AlertDialog.Builder(UslotteryRecord_yskcActivity.this)
					.setTitle("温馨提示!")
					.setMessage("选择拍照还是图库")
					.setPositiveButton("拍照",
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									UslotteryRecord_yskcActivity.this
			...
			if (requestCode == 2) {
				...
				for (int i = 0; i < picPath.length; i++) {
					...
					imagepath = Environment.getExternalStorageDirectory()
							+ "/myimage/l" + Util.getCurTime() + i + ".jpg";
					String str = ImageCompress.compressImage3(bitmap,
							UslotteryRecord_yskcActivity.this, imagepath);
