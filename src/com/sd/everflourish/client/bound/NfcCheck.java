...
import com.uslotter.nfc.JkConfirm;
...
public class NfcCheck extends BaseSdActivity {
	// NFC parts
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//}else{
					//Toast.makeText(NfcCheck.this,"请输入7位IC卡编号", Toast.LENGTH_SHORT).show();
					//return ;
				//}
...
//		});
	...
	public void goJkConfirmActivityByTitle(String title) {
		 ...
		 intent.setClass(this, JkConfirm.class);
		 intent.putExtra("title", title);
		 //intent.setAction("android.intent.action.JKCONFIRM");
	     startActivity(intent);
	    // Log.d("1111111111", title);
	}
